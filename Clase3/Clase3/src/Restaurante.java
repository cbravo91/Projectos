...
public class Restaurante {
   ...
   Scanner input = new Scanner(System.in);
    ...
    public Mesa elegirMesa(int cantSentados) {
        ...
        return mesas.get(Integer.parseInt(input.nextLine()));
    }

    public void sentarse(int personasSentadas, Mesa mesa) {
          mesa.setPersonasSentadas(mesa.getCapacidad()-personasSentadas);
    }
